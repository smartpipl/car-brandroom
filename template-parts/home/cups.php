<section class="cups">
    <div class="container flex__center">
        <div class="container-header">
            <p class="overline--32 color-yellow">My medals and cups</p>
            <h3>Conquered peaks and victory symbols</h3>
        </div>
        <div class="container-unfolding">
            ...
            <div>
                <button id="view-cup" class="button secondary">View all cups</button>
            </div>
        </div>
    </div>
</section>